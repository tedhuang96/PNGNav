...
# config_name = "square_2d"
config_name = "square_2d_hard"
...
num_samples_per_env = config['num_samples_per_env'] # make sure it is not a too hard environment
total_env_count = 0
invalid_env_count = 0
for mode in ['train', 'val', 'test']:
