...
from png_navigation.wrapper.pointnet_pointnet2.pointnet2_wrapper import PNGWrapper as NeuralWrapper
from png_navigation.datasets.point_cloud_mask_utils_updated import get_point_cloud_mask_around_points, \
...
class NeuralWrapperNode:
    def __init__(
        ...
        rospy.init_node('png_navigation_nrrt_star_neural_wrapper_node', anonymous=True)
